...
public enum WhoopCommand: UInt8, CaseIterable {
    ...
    public var label: String {
        ...
        case .sendHistoricalData:    return "Senden Historical Daten"
        case .historicalDataResult:  return "Historical Daten Result"
        case .getBatteryLevel:       return "Get Akku Level"
        case .getDataRange:          return "Get Daten Range"
        ...
        case .startRawData:          return "Start Raw Daten"
        case .stopRawData:           return "Stop Raw Daten"
        case .enterHighFreqSync:     return "Enter High-Freq Sync"
        case .exitHighFreqSync:      return "Exit High-Freq Sync"
        case .getExtendedBatteryInfo:return "Get Extended Akku Info"
        case .toggleIMUMode:         return "Toggle IMU Mode"
        case .enableOpticalData:     return "Enable Optical Daten"
