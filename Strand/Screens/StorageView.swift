...
struct StorageView: View {
    ...
    var body: some View {
        ScreenScaffold(title: "Storage",
                       subtitle: "Where LLB's on-device space is going, and a one-tap clean-up.") {
        ...
        return StrandCard {
            VStack(alignment: .leading, spacing: NoopMetrics.cardInnerSpacing) {
                ...
                Text(reclaimable > 0
                     ...
                     : "Nothing to reclaim right now. LLB already cleans up import scratch space automatically.")
