...
//
// The Apple-Fitness-x-WHOOP look scaled to the wrist: the three LLB rings (Charge / Effort / Rest) with
...
// one-line sleep summary. When nothing has synced yet we show a friendly "open LLB on your iPhone" state,
...
// MARK: - ScoreRing — one clean LLB ring scaled for the wrist
//
