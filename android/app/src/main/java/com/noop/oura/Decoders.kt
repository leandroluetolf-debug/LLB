...
object OuraDecoders {
     ...
     * (s6.3: "7 amplitudes: first byte<<3, rest byte<<shift"). LLB v1 deliberately decodes the R-R
     ...
     * Returns null on a short body. LLB consumes this as the ring's OWN RMSSD-derived HRV tag.
     */
     ...
     *
     * CONFLICT (s6.10): open_oura-r3 reads percent at body[0], open_ring reads voltage at [4]. LLB
