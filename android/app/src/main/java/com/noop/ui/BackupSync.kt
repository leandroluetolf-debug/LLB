 ...
 * app) and you get off-device backup with NO in-app cloud account, no OAuth, no secrets - LLB only
...
object BackupSyncPrefs {
    ...
    /** Master enable for the daily auto-backup. Default OFF (every LLB automation is opt-in). */
