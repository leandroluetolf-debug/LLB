...
object TrendsReportRenderer {
    ...
    fun renderPdf(
        ...
        val file = File(dir, "LLB-trends-${report.start}_to_${report.end}.pdf")
    ...
    private fun drawHeader(canvas: Canvas, report: RangeReport, range: ReportRange, top: Float): Float {
        ...
        val left = MARGIN + 16f
        var ty = cardTop + 26f
        text(canvas, "LLB", left, ty, 11f, sansBold, ACCENT, letterSpacing = 0.12f)
    ...
    private fun drawFooter(canvas: Canvas, generatedOn: String) {
        ...
        text(
            canvas,
            "Generated by LLB on $generatedOn · all on-device, no account, no cloud.",
    ...
    fun export(
        ...
        runCatching {
            ...
            val send = Intent(Intent.ACTION_SEND).apply {
                ...
                putExtra(Intent.EXTRA_SUBJECT, "LLB trends report")
