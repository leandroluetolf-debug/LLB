...
//
// Single source of truth for the in-app "Neuigkeiten" sheet and the expectation-setting
...
object AppChangelog {
    ...
    val releases: List<Release> = listOf(
        ...
        Release(
            ...
            items = listOf(
                ...
                "**A batch of fixes.** The Deep Timeline HRV chart was plotting raw heartbeat intervals, not HRV, now it shows real, filtered HRV (#803). Cycle Awareness is only offered where it applies and has a proper off switch (#801). The app no longer gets sluggish after a very large Apple Gesundheit import (#797). And WHOOP 4.0 steps now explain that the strap has no step counter, rather than looking broken (#807).",
                ...
                "**Small wins.** Swipe or tap arrows to move between days. Löschen a hydration entry and set a custom container size. See each workout's effort number on its detail.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Storage clean-up (iPhone).** A failed or retried Apple Gesundheit import could strand a multi-gigabyte copy the Storage screen never saw; LLB now reclaims those leftovers automatically. (No Android-facing change - this was an iPhone import path.) Thanks @exzanimo (#590).",
            ),
        ),
        Release(
            version = "6.2.1",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**See everything, second by second: the new Deep Timeline.** Open a metric and pinch to zoom from a whole day right down to per-second detail. Your strap records far more than the old 5-minute averages let you see, and now you can: heart rate, HRV, SpO2, skin temperature, respiration and movement, all at full resolution, all on your device. Find it on the Entdecken tab. Thanks to everyone who asked for this (#575, #574, #582).",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Clearer help when a WHOOP 5/MG won't pair.** Instead of looping silently it now shows the steps to fix it: close the official WHOOP app, hold the band until the lights flash blue, then Forget This Device under Einstellungen > Bluetooth. (#78)",
                "Plus the home-screen widget says Charge instead of Erholung now, and workout durations stop clipping on the Heute \"Last Workouts\" tiles. (#332)",
            )),
        Release(
            version = "5.2.6",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Fixed: the Schlaf tab could get stuck on a single night.** The date arrows now step by day, so newer nights show up and the arrows behave.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**The home screen now matches iPhone and Mac.** One clean header row - your photo, the day with its arrows, the bell and the **+**, all in line - and the four-tab bar floats with room to breathe above the navigation buttons. The old menu button is gone: everything still lives one tap away under **Mehr**.",
                "**Cleaner rings.** The little dots on the Charge / Effort / Rest rings now disappear when there's nothing to show yet, so empty and kalibriert rings read calm and clean.",
                "**Crisper across the board.** Flatter cards, bolder figures and tidier spacing on every screen, to match the rest of the app.",
                "**Little extras brought over from iPhone:** a quick **Jetzt synchronisieren** on Gesundheit, a **What moves you** shortcut on Einblicke, the **Exportieren report** card right on Trends, and your **profile photo** in its own spot in Einstellungen.",
            )),
        Release(
            version = "5.1.0",
        ...
        Release(
            version = "4.9.1",
            title = "Mehr realistic calories + import & chart fixes",
            date = "June 2026",
            items = listOf(
                "**Mehr realistic daily calories.** The all-day energy estimate was running high - it credited ordinary daytime heart rate at exercise intensity. Now only genuine exertion counts at the higher rate. (Thanks to everyone on the subreddit who flagged it.)",
                "**Gesundheit Connect workouts now show on the Heute graph.** A workout imported from Gesundheit Connect now gets its marker on the Heute heart-rate graph, just like recorded and manually-added workouts.",
                "**Fixed WHOOP-import day shift.** Importierening a WHOOP export could file a night's sleep on the wrong day (a day early) and split it across two days - it now lands on the correct wake-day.",
            ),
        ),
        Release(
            version = "4.9.0",
            ...
            date = "June 2026",
            items = listOf(
                "**Steadier live heart rate.** The Gesundheit screen now shows the same spike-filtered reading as the Live screen, so a brief sensor blip no longer flashes a wild number like 170+. (Thanks @ryanbr and @bringiton321 - #39.)",
                "**Löschend sleep stays deleted.** A sleep session you delete no longer reappears after the next on-device recompute. (Thanks @ryanbr and @pikapik487 - #33.)",
                "**Step calibration finds your phone steps.** Calibration now reads your phone's step count from both Apple Gesundheit and Gesundheit Connect imports - previously it could miss them and leave you stuck on \"Not calibrated\". (Thanks @pikapik487 and @bringiton321 - #37.)",
            ),
        ),
        Release(
            version = "4.8.0",
            ...
            items = listOf(
                ...
                "**New: feel the time - Haptic Clock.** Your strap can now buzz out the current time: long buzzes for tens, short for units, hours then minutes. Tap \"Buzz the time on your strap\" in Einstellungen → Diagnostics. (#460.)",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "**Fixed:** the **Effort** ring on the new Heute screen could render as a squashed oval (the three rings didn't quite fit the width, so the last one got pinched). All three are now perfect circles, whatever your screen size.",
            ),
        ),
        Release(
            version = "4.6.3",
            title = "The new Heute screen comes to Android",
            date = "June 2026",
            items = listOf(
                "**The WHOOP-style Heute hero is now on Android too.** Charge, Effort and Rest are three glowing rings - Charge enlarged in the centre, Rest and Effort flanking it - over the scenic backdrop, matching iPhone and Mac. The old gold recovery ring made way for it, and your HRV / Ruhe-HF / Atmung read-outs now sit just below. (Finishing the #23 redesign on Android.)",
            ),
        ),
        Release(
            version = "4.6.2",
        ...
        Release(
            ...
            items = listOf(
                ...
                "**Better on-device debug export:** the in-app strap log now keeps a rolling **24 hours** (up from ~1h), exported logs and raw captures get a **date-stamped filename**, and a new one-tap **\"Exportieren raw + log\"** hands over both as a matched pair. (#510)",
            ),
        ),
        Release(
            version = "4.5.5",
            ...
            items = listOf(
                ...
                "**The strap log is now in Einstellungen on iPhone too** (Einstellungen → Band → Copy / Speichern), matching Mac - easy to grab for a bug report without hunting on the Live screen. (#509)",
            ),
        ),
        Release(
            version = "4.5.4",
            ...
            date = "June 2026",
            items = listOf(
                "Added a **Band log** shortcut to **Einstellungen → Band** on Mac - Copy or Speichern the log right from Einstellungen instead of hunting for it on the Live screen. (Android already had it in Einstellungen.)",
            ),
        ),
        Release(
            version = "4.5.3",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "A gentle move reminder, if you want one. Turn it on in Einstellungen → Automationen and LLB buzzes your strap after you've been sitting still too long (your threshold, default 45 min), within hours you choose (default 9-5), with a cooldown you set. Off by default, runs from the motion already on your strap, and respects quiet hours and only-when-worn. Thanks @cbarrado (#419).",
            ),
        ),
        Release(
            version = "4.2.0",
            ...
            items = listOf(
                ...
                "Aktivität Cost: a new Einblicke section learns what each activity costs your recovery - the next-morning Charge hit and days-to-bounce-back, measured against your own untouched rest-day baseline, with a confidence level. Thanks @subscriptiondestroyer (#439).",
                ...
                "Letzte Nacht syncs sooner: LLB keeps a deep backlog draining while you're connected instead of waiting 15 minutes between bursts, plus a Jetzt synchronisieren button to backfill on demand. Thanks @idkwargwanbear (#364).",
                "Gewicht from Gesundheit Connect now shows in Vergleichen - it was invisible there before. (#443)",
            ),
        ),
        Release(
            version = "4.1.1",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Schritte on a WHOOP 4.0 - estimated, and calibrated to you. A WHOOP 4.0 doesn't send a step count over Bluetooth, so LLB now estimates your daily steps from the strap's own motion and calibrates that against your phone's step count (Apple Gesundheit / Gesundheit Connect) - learning a coefficient personal to your gait. It's honest about what it is: an estimate, never a pretend pedometer - shown with an \"est.\" marker, and \"—\" when there isn't enough movement to say.",
                "A Schritte calibration screen (Einstellungen → Profil → Schritt-Schätzung): see your estimate next to your phone's real count, how confident the fit is, and a manual dial to tune it to you with a live preview. No phone steps to calibrate against? Set the dial by hand.",
        ...
        Release(
            ...
            items = listOf(
                ...
                "The Heute stress timeline gets a Y-axis and tap-to-read - labelled stress levels, and you can scrub the chart to read each hour. Thanks @ujix (#441).",
            ),
        ),
        Release(
            version = "4.0.3",
            ...
            date = "June 2026",
            items = listOf(
                "Heute's date now matches Intelligenz History. The Heute/Erholung screen could label a day with one date while showing the previous day's numbers (when this morning's recovery wasn't scored yet) - so it disagreed with the same day in Intelligenz History. The Heute date now names the row actually on screen. Thanks @pikapik487 (#434).",
                "Clearer diagnostics for non-WHOOP heart-rate straps. Connecting a generic strap (Polar, Wahoo, Coospo…) now records every step of the Bluetooth handshake in the strap log - scan, connect, service discovery, notification enable, first reading - so a \"connected but keine Daten\" report can actually be diagnosed. Adds a single auto-retry on the common Android 133 connect error. Thanks @pilleuspulcher-blip (#421).",
                "UI polish: the \"vs previous month\" comparison in Entdecken no longer clips; the bedtime/wake time-scale label isn't cut off; the Einblicke day order is now Gestern → Heute → Tomorrow; and the \"Journal\" heading stays on one line. Thanks @nhe (#443).",
            ),
        ),
        Release(
            version = "4.0.2",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Polish from a full code review: your Vitalität breakdown now reconciles exactly with the Körper Age number it explains; the new Age cards always compute on Android (the age control is bounded like iPhone/Mac); and live workout detection now covers the whole calendar day. Thanks @rad182, @cbarrado, @j0b-dev.",
            ),
        ),
        Release(
            version = "4.0.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "iPhone/Mac: the three Charge / Effort / Rest rings on Heute no longer render squished with their state word overlapping the arc on larger iPhones - each ring sizes to its card and the labels scale to fit. Thanks @claypilat (#403).",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Einblicke “By Day” stays smooth with years of history: tapping All with a big imported history used to build jeden Tag at once and could freeze the app. The list now renders only what's on screen, so it scrolls smoothly no matter how many days you've imported. Thanks @maddognik (#345).",
                "Honest Apple Gesundheit guidance on free sideloads (iPhone): if you installed LLB with a free Apple ID (AltStore / Sideloadly), the build can't be granted Apple Gesundheit access - so instead of pointing you to a Einstellungen screen LLB can never appear in, it now tells you straight and routes you to the file-import / Shortcuts path. Thanks @exzanimo (#348).",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Schlaf corrections now stick: when you hand-correct a night's bed/wake times, the correction survives the next strap sync instead of quietly reverting - bringing Android up to iPhone/Mac. The edited night is no longer re-derived over, and editing the bedtime no longer risks a duplicate row.",
            ),
        ),
        Release(
            version = "3.5.0",
            ...
            items = listOf(
                ...
                "Schlaf (iPhone/Mac): you can now hand-correct a night's bed/wake times with a pencil on the Schlaf tab - LLB re-stages from the raw sensor data and the correction survives the next strap sync. (Android already has bed/wake editing; durable-edit parity is tracked.) Thanks @claypilat (#395).",
            ),
        ),
        Release(
            version = "3.4.0",
            ...
            items = listOf(
                ...
                "Heute: the three daily scores (Charge / Effort / Rest) now sit in one tidy row of rings (an iPhone/Mac layout fix). Thanks @vulnix0x4 (#394).",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Added CrossFit, Wandern and Tennis to the quick re-label list when you change a detected workout's type (every platform). Mehr workout-management discoverability improvements are on the way. Thanks @marceauboul (#318).",
            ),
        ),
        Release(
            version = "3.3.0",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Several fixes in this release are iPhone/Mac-only by nature (VoiceOver on the HR chart, Reduce Motion on the breathing orb, Dynamic Type, Live-Aktivität end-on-disconnect, background-restore decoding, the Mac menu-bar toggle); Android is versioned in lockstep so every platform tells the same story.",
            ),
        ),
        Release(
            version = "3.0.3",
            ...
            date = "June 2026",
            items = listOf(
                "Fixed on iPhone/Mac - a large multi-year Apple Gesundheit import could exhaust memory and close the app; the importer now aggregates day-by-day as it reads. Android already worked this way, so no Android-facing change; versioned in lockstep. Thanks @exzanimo (#355).",
            ),
        ),
        Release(
            version = "3.0.2",
            ...
            date = "June 2026",
            items = listOf(
                "This patch is focused on Mac/iPhone - a Bluetooth stream-resync hardening (Android already carried this guard) and an iPhone Apple Gesundheit two-way-sync fix. No Android-facing changes; versioned in lockstep. Thanks @vulnix0x4 (#374, #375).",
            ),
        ),
        Release(
            version = "3.0.1",
            ...
            items = listOf(
                ...
                "Fixed: Schritte prefer your strap's own on-device count (WHOOP 5/MG) over imported data where available. Thanks @netizentryingtofitin (#276).",
            ),
        ),
        Release(
            version = "3.0.0",
        ...
        Release(
            version = "2.18.5",
            title = "Heute tiles no longer cut their value to \"10…\"",
            date = "June 2026",
            items = listOf(
                "Fixed: on phones, Heute tiles that show a sparkline (Charge, Rest, Atmung, HRV…) were truncating their value to \"10…\" or \"15…\" because the value and the inline trend line were competing for width. The value now shrinks to fit the way it already does on Mac/iPhone, so it always reads in full. Thanks @asemfahad (#332).",
            ),
        ),
        Release(
            version = "2.18.4",
        ...
        Release(
            ...
            items = listOf(
                ...
                "New: you can now **delete a sleep session** - tap the trash icon on the Schlaf screen to remove a mis-detected night. Thanks @ryanbr (#281).",
            ),
        ),
        Release(
            version = "2.14.0",
        ...
        Release(
            version = "2.13.0",
            title = "A WHOOP-style Heute chart, clearer sleep times - and a big iPhone update",
            date = "June 2026",
            items = listOf(
                ...
                "New: the **Schlaf** screen now shows your **asleep and woke times** at a glance.",
                "This release also brought a large iPhone + Mac update - an accessibility pass, two-way Apple Gesundheit, pull-to-refresh, Siri shortcuts and a lot of polish - with the cross-platform pieces brought here too. Thanks @vulnix0x4, @khalilkm01 and @rad182.",
            ),
        ),
        Release(
            version = "2.12.0",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "New: a **sleep-debt ledger** on the Schlaf screen - a running 14-night balance of sleep banked versus your personal need, with a plain-English read and a per-night chart.",
                ...
                "New: a **recovery forecast** on the Intelligenz screen - an evening estimate of tomorrow morning's Charge from today's effort, planned sleep and your recent baseline. Clearly an estimate, shown once there's enough history.",
                "New: **navigate Heute day by day** - chevrons and a date-picker jump replace the fixed 3-day selector.",
                "New: a live **strap-battery %** and **recorded-nights streak** on the Heute header.",
            ),
        ),
        Release(
            version = "2.9.0",
            ...
            items = listOf(
                ...
                "Fixed: the 'Rest' tile on Heute now shows your Rest SCORE (out of 100, like Charge and Effort), with hours-in-bed as the caption - it was showing the hours where the score should be. Thanks @subscriptiondestroyer (#248).",
                "New: the Schlaf screen gains in-app bed/wake-time editing - fix a mis-detected night and every metric recomputes live - plus Hours-vs-Needed and Schlaf-Consistency cards, night-by-night navigation, and tappable metric details. Thanks @ujix.",
                ...
                "New: tap-and-drag to inspect the Stress chart, and a cleaner Entdecken metric picker. Thanks @ujix.",
        ...
        Release(
            ...
            date = "June 2026",
            items = listOf(
                "Fixed: the Einblicke tab crashed for anyone with journal entries - a text-matching pattern used a flag that works on a computer but not on Android’s engine, so it threw the moment you opened Einblicke. Fixed. Thanks @pilleuspulcher-blip and @maddognik (#224/#267).",
                ...
                "New: the Intelligenz ‘By Day’ list gets a W / M / 3M / 6M / 1Y / ALL range filter to narrow to a recent window. Thanks @ujix (#252).",
                "New: the Heute heart-rate chart is now tap-and-drag interactive, matching iPhone and Mac. Thanks @ujix (#254).",
            ),
        ),
        Release(
            version = "2.8.8",
        ...
        Release(
            ...
            items = listOf(
                ...
                "Fixed: a workout imported from Gesundheit Connect could show no distance even when the distance was recorded - a relay app (e.g. Suunto via Gesundheit Sync) often writes the distance with timestamps slightly offset from the workout, which LLB's exact-window match missed. It now matches with a tolerance. Thanks @pilleuspulcher-blip. (#215)",
                "Fixed (iPhone): on the Entdecken screen, tapping a metric could bounce you back to the Mehr tab - a nested-navigation bug, now fixed. Thanks @sebastianwoo. (#199)",
            ),
        ),
        Release(
            version = "2.8.6",
    ...
    val expectations: List<Expectation> = listOf(
        ...
        Expectation(
            ...
            body = "Live heart rate is instant. Erholung, strain and sleep sharpen as LLB learns your baseline over your first nights of wear. Want your history now? Importieren your WHOOP export in Datenquellen and it backfills in about a minute.",
        ),
        Expectation(
