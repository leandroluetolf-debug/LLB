...
/**
 * OPT-IN writeback: pushes LLB's on-device computed nightly metrics (resting HR, HRV RMSSD, sleep
 ...
 *    (or loop our own import). What LLB computed from the strap is genuinely ours to contribute.
...
object HealthConnectWriter {
    ...
    /**
     * #528 — export LLB's heart-rate samples (raw [deviceId], not computed) above the persisted
