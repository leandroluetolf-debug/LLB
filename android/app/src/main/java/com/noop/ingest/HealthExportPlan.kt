...
/**
 * Pure (Android-free, HC-SDK-free) planning logic for what LLB exports INTO Health Connect.
 *
 ...
 * metrics LLB genuinely computed — daily steps, active energy, heart-rate series, sleep sessions —
 * into Health Connect for other apps. Honest: only days/samples LLB actually has are emitted; a
...
object HealthExportPlan {
     ...
     *  matches what the rest of LLB already considers asleep. */
