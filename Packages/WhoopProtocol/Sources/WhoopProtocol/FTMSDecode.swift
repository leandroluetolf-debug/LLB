...
//
// Spec-deterministic field parsing for the four FTMS machine-data characteristics LLB reads live:
...
// Supplement" characteristic field tables. LLB's own clean re-implementation of the public spec.
