...
// We decode the fields LLB surfaces in a live workout (speed, cadence, power, and the cumulative
...
// 1.0, "Cycling Power Service" 1.1, and the GATT Specification Supplement field tables. LLB's own clean
