...
/// tests pin is CONSISTENCY: the spot value uses the SAME RMSSD math as LLB's nightly HRV
...
final class SpotHrvReadingTests: XCTestCase {
    ...
    /// Textbook RMSSD with the Task Force (1996) SAMPLE denominator (n-1) — the reference LLB uses.
