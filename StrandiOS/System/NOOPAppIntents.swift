...
struct MarkMomentIntent: AppIntent {
    ...
    static var description = IntentDescription("Record a timestamped moment in LLB.")
...
/// Surfaces LLB's intents to Siri, Spotlight, and the Shortcuts gallery without any user setup.
